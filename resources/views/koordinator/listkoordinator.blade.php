...
@if(session()->has('success'))
  ...
  @endif
    ...
    <h3 class="font-weight-bold">Data Koordinator</h3>
        </div>
</div>
    <div class="col-md-12 grid-margin">
                    ...
                    <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/edit')}}/{{$user->id}}" type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#Modal{{$user->id}}">
                                    <i class="icon-eye menu-icon" style="color: black"></i></a>
                                  <!-- Modal Edit -->
<div class="modal fade modal-lg" id="Modal{{$user->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body content-wrapper">
                    <div class="card ">
                      <div class="card-body">
                        <form class="forms-sample" action="{{url('/updateprogres')}}/{{$user->id}}" method="POST">
                          @csrf
