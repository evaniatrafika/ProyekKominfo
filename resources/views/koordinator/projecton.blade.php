                    ...
                    <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-warning" href="{{url('/detailongoing')}}/{{$project->id}}" ><i class="icon-plus menu-icon" style="color: black"></i></a>
                                ...
                                <div class="modal fade modal-lg" id="ModalDel{{$project->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                  ...
                                  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                  <a href="{{url('/delete')}}/{{$project->id}}" type="button" class="btn btn-danger">
