  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-3 stretch-card transparent">
      <div class="card card-tale">
        <div class="card-body">
          <p class="mb-3">Project Menunggu Konfirmasi</p>
          <p class="fs-30 mb-2">{{ $project_waiting }}</p>
          <?php 
          $project_waiting = (int)$project_waiting;
          if($project_waiting >= 1){
            ?> <div class="text-danger"><b>Menunggu Dikonfirmasi !</div> </b><?php 
          }else{
            ?> <div class="text-light"><b>Tidak Ada</b></div> <?php 
          }
          ?>
        </div>
      </div>
